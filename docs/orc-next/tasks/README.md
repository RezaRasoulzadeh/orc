...
| [M02-003](M03-001.md) | Done | M02 | Enforce reliable structured Controller output |
...
| [M05-002](M05-002.md) | Planned | M05 | Persist Controller plan proposals through explicit authorization |
