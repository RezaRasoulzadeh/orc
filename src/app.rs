...
impl OrcApp {
    ...
    /// Persist one explicitly curated Controller recovery recommendation
    /// through the canonical M08-001 dataset API. This performs no inference
    /// or automatic harvesting.
    pub fn create_controller_recovery_experience_example(
        &self,
        request: &crate::controller_experience_recovery::ControllerExperienceRecoveryRecommendationRequest,
    ) -> Result<crate::controller_experience::ControllerExperienceExample> {
        let draft = request
            .into_example_draft()
            .map_err(|error| anyhow::anyhow!(error))?;
    ...
    /// Persist one explicitly curated Controller planning result through the
    /// canonical M08-001 dataset API. This performs no inference or automatic
    /// harvesting.
    pub fn create_controller_planning_experience_example(
        &self,
        request: &crate::controller_experience_planning::ControllerExperiencePlanningRequest,
    ) -> Result<crate::controller_experience::ControllerExperienceExample> {
        let draft = request
            .into_example_draft()
            .map_err(|error| anyhow::anyhow!(error))?;
    ...
    /// Persist one explicitly curated Controller workflow-intake result
    /// through the canonical M08-001 dataset API. This performs no inference
    /// or automatic harvesting.
    pub fn create_controller_intake_experience_example(
        &self,
        request: &crate::controller_experience_intake::ControllerExperienceIntakeRequest,
    ) -> Result<crate::controller_experience::ControllerExperienceExample> {
        let draft = request
            .into_example_draft()
            .map_err(|error| anyhow::anyhow!(error))?;
    ...
    /// Persist one explicitly curated Controller Plan-review result through
    /// the canonical M08-001 dataset API. This performs no inference or
    /// automatic harvesting.
    pub fn create_controller_plan_review_experience_example(
        &self,
        request: &crate::controller_experience_plan_review::ControllerExperiencePlanReviewRequest,
    ) -> Result<crate::controller_experience::ControllerExperienceExample> {
        let draft = request
            .into_example_draft()
            .map_err(|error| anyhow::anyhow!(error))?;
    ...
    /// Persist one explicitly curated Controller memory-capture judgment
    /// through the canonical M08-001 dataset API. This performs no inference,
    /// memory lookup, mutation, grant handling, or automatic harvesting.
    pub fn create_controller_memory_capture_experience_example(
        &self,
        request: &crate::controller_experience_memory_capture::ControllerExperienceMemoryCaptureRequest,
    ) -> Result<crate::controller_experience::ControllerExperienceExample> {
        let draft = request
            .into_example_draft()
            .map_err(|error| anyhow::anyhow!(error))?;
    ...
    /// Persist one explicitly curated Controller memory-selection judgment
    /// through the canonical M08-001 dataset API. This performs no inference,
    /// candidate enumeration, target lookup, maintenance, mutation, grant
    /// handling, or harvesting.
    pub fn create_controller_memory_selection_experience_example(
        &self,
        request: &crate::controller_experience_memory_selection::ControllerExperienceMemorySelectionRequest,
    ) -> Result<crate::controller_experience::ControllerExperienceExample> {
        let draft = request
            .into_example_draft()
            .map_err(|error| anyhow::anyhow!(error))?;
